  ...
  return (
    <div className='training-registration' style={{display: open?"block":"none"}}>
        ...
        <div className='training-registration-group-alone table'>
            <div className="training-registration-group-alone-item left" style={{borderTopLeftRadius: "10px", borderBottomLeftRadius: "10px"}}>
                <img src={doneImg} alt="" />
                <p>Խմբային դասընթացներ</p>
            </div>
            <div className="training-registration-group-alone-item rigth">
                <img src={doneImg} alt="" />
                <p>Անհատական դասընթացներ</p>
            </div>
        </div>
        <div className="training-registration-method table">
            <div className="training-registration-method-item left">
                <img src={doneImg} alt="" />
                <p>Վիդեո դասեր</p>
            </div>
            <div className="training-registration-method-item">
                <img src={doneImg} alt="" />
                <p>Ուղիղ միացմամբ</p>
            </div>
            <div className="training-registration-method-item rigth">
                <img src={doneImg} alt="" />
                <p>Դասասենյակում</p>
            </div>
        </div>
        <div className="training-registration-lang table">
            <div className="training-registration-lang-item left">
                <img src={doneImg} alt="" />
                <p>Հայերեն</p>
            </div>
            <div className="training-registration-lang-item ">
                <img src={doneImg} alt="" />
                <p>Ռուսերեն</p>
            </div>
            <div className="training-registration-lang-item rigth">
                <img src={doneImg} alt="" />
                <p>Անգլերեն</p>
            </div>
        </div>
